...
In this section we'll use the [NHANES](./Data.html) to illustrate scalar-on-function regression (sofr).
...
```
Note that the fPCs scores are uncorrelated and normalized, so the magnitude of the estimated coefficients is interpretable. 
